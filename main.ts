import { AtletaProfessionista, AtletaSemiProfessionista, AtletaDilettante } from './atleta';
...
let atleta1 = new AtletaProfessionista(101, 'Giovanni', 'Rossi', new Date(1990, 0, 1), 2, 0);
let atleta2 = new AtletaSemiProfessionista(102, 'Marco', 'Bianchi', new Date(1995, 5, 10), 10, 100);
let atleta3 = new AtletaDilettante(103, 'Luca', 'Verdi', new Date(2000, 7, 15), 8, 300);
let atleta4 = new AtletaSemiProfessionista(104, 'Francesca', 'Neri', new Date(1997, 2, 20), 3, 250);
