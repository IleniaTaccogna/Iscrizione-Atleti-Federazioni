...
const athlete1 = new ProfessionalAthlete(101, 'Ilenia', 'Taccogna', new Date(2001, 8, 5), 1, 0);  
...
const athlete5 = new SemiProfessionalAthlete(104, 'Leonardo', 'Galluzzi', new Date(1997, 2, 20), 3, 250);
...
atletica.registerAthlete(athlete5); 
