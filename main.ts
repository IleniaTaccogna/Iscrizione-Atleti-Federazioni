...
let athlete1 = new ProfessionalAthlete(101, 'Giovanni', 'Rossi', new Date(1990, 0, 1), 2, 0);
let athlete2 = new SemiProfessionalAthlete(102, 'Marco', 'Bianchi', new Date(1995, 5, 10), 10, 100);
let athlete3 = new AmateurAthlete(103, 'Luca', 'Verdi', new Date(2000, 7, 15), 8, 300);
let athlete4 = new SemiProfessionalAthlete(104, 'Francesca', 'Neri', new Date(1997, 2, 20), 3, 250);
let athlete5 = new AmateurAthlete(103, 'Silvia', 'DeNicolò', new Date(2000, 7, 15), 8, 300);
let athlete6 = new ProfessionalAthlete(101, 'Ilenia', 'Taccogna', new Date(1990, 0, 1), 2, 0);
let athlete7 = new ProfessionalAthlete(101, 'Nicolas', 'Fortunato', new Date(1990, 0, 1), 2, 0);
