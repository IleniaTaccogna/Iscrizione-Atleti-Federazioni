...
const athlete1 = new athlete_1.ProfessionalAthlete(101, 'Ilenia', 'Taccogna', new Date(2001, 8, 5), 1, 'Professional', 0);
const athlete2 = new athlete_1.SemiProfessionalAthlete(102, 'Silvia', 'De Nicolò', new Date(2000, 1, 6), 10, 'SemiProfessional', 100);
const athlete3 = new athlete_1.AmateurAthlete(103, 'Jambo', 'Kenyan', new Date(2015, 7, 16), 8, 'Amateur', 300);
const athlete4 = new athlete_1.SemiProfessionalAthlete(104, 'Leonardo', 'Galluzzi', new Date(1997, 2, 20), 3, 'SemiProfessional', 250);
