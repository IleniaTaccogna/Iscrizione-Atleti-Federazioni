...
const tennis = new federation_1.Federation(2);
// Creazione degli atleti
const athlete1 = new professionalAthlete_1.ProfessionalAthlete(101, 'Ilenia', 'Taccogna', new Date(2001, 8, 5), 1, 0);
...
const athlete5 = new amateurAthlete_1.AmateurAthlete(105, 'aria', 'DeFilippi', new Date(1967, 7, 16), 8, 300);
